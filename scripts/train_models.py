...
if __name__ == '__main__':
    ...
    if start_from_DL2:
        ...
        # Prod5
        dl2_file_name = (
            '/home/thassan/Paquetes/last_version/iact_event_types/eventDisplay_files/'
            'gamma_onSource.S.BL-4LSTs25MSTs70SSTs-MSTF_ID0.eff-0.root'
        )
        dtf = event_types.extract_df_from_dl2(dl2_file_name)
    else:
        dtf = event_types.load_dtf('gamma_onSource.S.BL-4LSTs25MSTs70SSTs-MSTF_ID0.eff-0.root')
