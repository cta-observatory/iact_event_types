...
def plot_variable_importance(trained_model, model_name, energy_bin, train_features):
    '''
    Plot the importance of the variables for the provided trained_model in the 'energy_bin'.

    Parameters
    ----------
    trained_model: a trained sklearn model for one energy range
    model_name: str
        The model name (as defined in define_regressors/classifiers())
    energy_bin: str
    ...
    if hasattr(trained_model, 'feature_importances_'):
        ...
        print('Warning: importances cannot be calculated for the {} model'.format(model_name))
        return None
